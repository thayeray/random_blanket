...
class RangeSliderUI extends BasicSliderUI {
	...
	/** Scales the size for thumbs found by the calculateThumbSize override  */
	private final double THUMB_SIZE_MULTIPLIER = 1.3;	// TAY edit, introduced the multiplier
	
    /** Color of selected range. */
    private Color rangeColor = Color.GREEN;
    
    /** Color of the upper thumb.  */
    private Color upperThumbColor = Color.RED;			// TAY edit, changed color from PINK
    
    /** Color of the lower thumb.  */
    private Color lowerThumbColor = Color.BLUE;			// TAY edit, changed color from CYAN
...
*/
    ...
    /**
     * Accessor for the Color object for the upper thumb
     */
    public Color getUpperThumbColor()						// TAY edit, introduced accessor
    {
    	return upperThumbColor;
    }

    /**
     * Mutator for the Color object of the upper thumb
     */
    public void setUpperThumbColor(Color colorIn)			// TAY edit, introduced mutator
    {
    	upperThumbColor = colorIn;
    }
    
    /**
     * Accessor for the Color object of the lower thumb
     */
    public Color getLowerThumbColor()						// TAY edit, introduced accessor
    {
    	return lowerThumbColor;
    }
    
    /**
     * Mutator for the Color object of the lower thumb
     */
    public void setLowerThumbColor(Color colorIn)			// TAY edit, introduced mutator
    {
    	lowerThumbColor = colorIn;
    }
...
*/
    ...
    protected void calculateThumbSize() {
        ...
        thumbRect.setSize((int)Math.round(thumbRect.width * THUMB_SIZE_MULTIPLIER), 		// TAY edit, introduced the multiplier
        				  (int)Math.round(thumbRect.height * THUMB_SIZE_MULTIPLIER)); 		// TAY edit, introduced the multiplier
...
*/
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.setColor(lowerThumbColor);	// TAY edit
        g2d.fill(thumbShape);

        g2d.setColor(Color.BLACK);		// TAY edit
        g2d.draw(thumbShape);
...
*/
    private void paintUpperThumb(Graphics g) {
        ...
        g2d.setColor(upperThumbColor);	// TAY edit
        g2d.fill(thumbShape);
        g2d.setColor(Color.BLACK);		// TAY edit
        g2d.draw(thumbShape);
